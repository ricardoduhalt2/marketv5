// Types for LoadingPage component
...
// Star visual configurations
export const STAR_VISUALS = [
  { 
    name: 'cyan', 
    bg: 'bg-cyan-400', 
    shadow: 'shadow-[0_0_8px_2px_rgba(34,211,238,0.7)]', 
    hex: '#22d3ee', 
    tailFade: 'rgba(34,211,238,0)' 
  },
  { 
    name: 'pink', 
    bg: 'bg-pink-400', 
    shadow: 'shadow-[0_0_8px_2px_rgba(244,114,182,0.7)]', 
    hex: '#f472b6', 
  ...
  { 
    name: 'purple', 
    bg: 'bg-purple-400', 
    shadow: 'shadow-[0_0_8px_2px_rgba(192,132,252,0.7)]', 
    hex: '#c084fc', 
  ...
  { 
    name: 'yellow', 
    bg: 'bg-yellow-300', 
    shadow: 'shadow-[0_0_8px_2px_rgba(250,204,21,0.7)]', 
    hex: '#facc15', 
    tailFade: 'rgba(250,204,21,0)' 
  },
  { 
    name: 'white', 
    bg: 'bg-white', 
    shadow: 'shadow-[0_0_8px_2px_rgba(255,255,255,0.7)]', 
    hex: '#ffffff', 
  ...
  { 
    name: 'blue', 
    bg: 'bg-blue-400', 
    shadow: 'shadow-[0_0_8px_2px_rgba(96,165,250,0.7)]', 
    hex: '#60a5fa', 
  ...
  { 
    name: 'red', 
    bg: 'bg-red-400', 
    shadow: 'shadow-[0_0_8px_2px_rgba(248,113,113,0.7)]', 
    hex: '#f87171', 
    tailFade: 'rgba(248,113,113,0)' 
  },
];
